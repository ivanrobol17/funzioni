    ...
    do {
      ...
      switch (scelta) {
        case 1:
          ...
          int d = sc.nextInt();
          System.out.println(f.addFrazione(n, d));
          break;
        case 2:
          ...
          se = sc.nextInt();
          System.out.println( f.addFrazione(f.getFrazione(pr).somma(f.getFrazione(se))));
        ...
        case 4:
          ...
          System.out.println(seconda+ (f.dimensione()-1) + ")");
          se = sc.nextInt();
          System.out.println(f.addFrazione(f.getFrazione(pr).moltiplica(f.getFrazione(se))));
        ...
        case 5:
          ...
          System.out.println(seconda+ (f.dimensione()-1) + ")");
          se = sc.nextInt();
          System.out.println(f.addFrazione(f.getFrazione(pr).dividi(f.getFrazione(se))));
        ...
        System.out.println(indice+ (f.dimensione()-1) + ")");
        in = sc.nextInt();
        System.out.println(f.addFrazione(f.getFrazione(in).reciproca()));
